...
from backend.app.schemas.alerts import AlertTestResponse, EmailAlertRequest, SMSAlertRequest
...
async def test_alerts(current_user: User = Depends(get_current_active_user), alert_manager: AlertManager = Depends(get_alert_manager)):
