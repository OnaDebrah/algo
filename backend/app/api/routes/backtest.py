...
async def run_single_backtest(request: BacktestRequest, current_user: User = Depends(get_current_active_user)):
...
async def run_multi_asset_backtest(request: MultiAssetBacktestRequest, current_user: User = Depends(get_current_active_user)):
...
async def run_options_backtest(request: OptionsBacktestRequest, current_user: User = Depends(get_current_active_user)):
