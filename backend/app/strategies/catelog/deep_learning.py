            ...
            "integrated_moments": StrategyInfo(
                ...
                parameters={
                    "sequence_length": {
                        "default": 60,
                        "range": (30, 120),
                        "description": "Number of past days used for prediction"
                    },
                    "forecast_horizon": {
                        "default": 5,
                        "range": (1, 20),
                    ...
                    "min_risk_adjusted": {
                        "default": 0.5,
                        "range": (0.1, 2.0),
                        "description": "Minimum Sharpe-like ratio for entry"
                    },
                    "max_position": {
                        "default": 1.0,
                        "range": (0.1, 2.0),
                        "description": "Maximum position size (can exceed 1.0 with leverage)"
                    },
                    "confidence_threshold": {
                        "default": 0.6,
                        "range": (0.3, 0.95),
                        "description": "Minimum confidence for trading"
                    },
                    "use_adaptive_sizing": {
                        "default": True,
                        "type": "boolean",
                        "description": "Use Kelly-inspired dynamic position sizing"
                    },
                    "retrain_frequency": {
                        "default": 30,
                        "range": (7, 90),
