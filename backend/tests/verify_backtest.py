...
def test_trading_engine():
    ...
    engine = TradingEngine(strategy=strategy, initial_capital=10000, commission_rate=0.01, slippage_rate=0.01)
...
def test_multi_asset_engine():
    ...
    engine = MultiAssetEngine(strategies=strategies, initial_capital=20000, commission_rate=0.01, slippage_rate=0.01)
    ...
    aligned_data = {"dates": dates, "symbols": ["AAPL", "MSFT"], "data": {"AAPL": data, "MSFT": data}}
